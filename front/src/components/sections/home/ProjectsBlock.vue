          ...
          <div class="flex items-center justify-between text-xs pt-1.5 border-t border-white/5">
            ...
            <div class="flex items-center space-x-2.5">
              <a
                  ...
                  class="text-slate-400 hover:text-emerald-400 p-1.5 rounded bg-[#1A1E26] hover:bg-emerald-500/20 border border-white/5 hover:border-emerald-500/30 transition-all flex items-center justify-center"
              >
              ...
              >
                <span>{{ project.link_url.startsWith('#') ? project.link_url : project.link_url.replace(/^https?:\/\//, '').replace(/\.git$/, '') }}</span>
