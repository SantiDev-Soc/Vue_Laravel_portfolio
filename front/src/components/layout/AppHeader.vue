  ...
  <header class="sticky top-0 z-40 bg-[#0F1116]/90 backdrop-blur-md border-b border-white/5">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
      <div class="flex items-center space-x-3 cursor-pointer" @click="$emit('navigate', 'home')">
        <div class="h-9 w-9 bg-gradient-to-tr from-emerald-500 to-indigo-600 rounded-lg flex items-center justify-center font-mono font-bold text-white shadow-lg shadow-emerald-500/10">
          S
        </div>
